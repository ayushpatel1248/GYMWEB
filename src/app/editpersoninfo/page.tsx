...
const EditProfilePage: React.FC = () => {
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>, field: FormField): void => {
  ...
  return (isloading==true ?<div className='w-full flex justify-center h-screen items-center'><Loader/></div>:
    <div className="min-h-screen bg-gray-50 p-8">
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-center">Edit Profile Information</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              <Button
                ...
                variant="outline"
                size="icon"
                disabled={formData.membershipPlan<=plan ||!editStates.membershipPlan }
                onClick={() => handleChange('membershipPlan', Math.max(1, formData.membershipPlan - 1))}
              ...
              <Button
                ...
                onClick={() => handleChange('membershipPlan', formData.membershipPlan + 1)}
                className="transition-transform hover:scale-105"
              >
